      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <a href="#how-it-works" className="text-sm font-medium text-slate-600 hover:text-blue-500 transition-colors">
              ¿Cómo funciona?
            </a>
            <a href="#pricing" className="text-sm font-medium text-slate-600 hover:text-blue-500 transition-colors">
              Precios
            </a>
          </nav>
